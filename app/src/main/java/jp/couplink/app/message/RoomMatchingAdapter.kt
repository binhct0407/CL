 ...
 */
class RoomMatchingAdapter(internal var matchedUsers: MutableList<TargetUser>) : RecyclerView.Adapter<RoomMatchingAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RoomMatchingAdapter.ViewHolder {
        return RoomMatchingAdapter.ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_message_matched_user, null))
    }

    override fun onBindViewHolder(holder: RoomMatchingAdapter.ViewHolder, position: Int) {
    ...
    fun getUserAt(pos: Int): TargetUser {
        return matchedUsers!!.get(pos)
    }
