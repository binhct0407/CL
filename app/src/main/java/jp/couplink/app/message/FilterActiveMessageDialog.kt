...
import kotlinx.android.synthetic.main.fragment_message_filter_active_dialog.*

/**
 * Created by BinhTran on 12/21/2017.
 */

class FilterActiveMessageDialog : DialogFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        return inflater.inflate(R.layout.fragment_message_filter_active_dialog, container, false)
    }
