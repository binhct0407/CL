...
public class SendLikeAdapter extends RecyclerView.Adapter<SendLikeAdapter.ViewHolder> {
    Context context;
    private List<UserObject> userObjects;


    public SendLikeAdapter(Context context, ArrayList<UserObject> userObjects) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_send_like_layout, null));
    }
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.item_send_like_txt_Name)
        TextView txtStatus;
        @BindView(R.id.item_send_like_txt_UserInfo)
        ...
        void bindView(UserObject userObject) {
            ...
            txtStatus.setText(userObject.getTarget_user().getName());
